/**
 * Mocha Tests for Exacerbation records...
...
var data = require('./testdata/exacerbations.js');

describe('Exacerbations Record Tests:', function() {
    // Config Vars
    var url = config.url;
    ...
    describe('Testing Functions as Admin:', function() {
        ...
        it('Admin cant get List of Exacerbation Records of a certain Patient', function (done){
            request(url)
                .get(patData_url + '/exacerbations')
                .set('Authorization', 'Bearer ' + access_token)
                .expect(403)
                .end(function (err, res){
                    if (err) throw err;
        ...
        it('Admin cant create new Exacerbation Record', function (done){
            request(url)
                .post(patData_url + '/exacerbations')
                .set('Authorization', 'Bearer ' + access_token)
                .send (data.admin.newExacerbation)
                .expect(403)
                .end(function (err, res){
                    if (err) throw err;
                    done();
        ...
        it('Admin cant get a certain Exacerbation Records of a certain Patient', function (done){
            request(url)
                .get(patData_url + '/exacerbations/42')
                .set('Authorization', 'Bearer ' + access_token)
                .expect(403)
                .end(function (err, res){
                    if (err) throw err;
        ...
        it('Admin cant delete Exacerbation Record', function (done){
            request(url)
                .del(patData_url + '/exacerbations/42')
                .set('Authorization', 'Bearer ' + access_token)
                .expect(403)
                .end(function (err, res){
                    if (err) throw err;
    ...
    describe('Testing Functions as Doctor:', function() {
        ...
        it('Doctor can get Exacerbation Records of his patients', function (done){
            request(url)
                .get(patData_url+'/exacerbations')
                .set('Authorization', 'Bearer ' + access_token)
                ...
                .end(function (err, res){
                    ...
                    if (res.statusCode == 200) {
                        res.body.should.have.property('exacerbations');
                        list_length = res.body.exacerbations.length;
        ...
        it('Doctor can create new Exacerbation Records Data', function (done){
            var tmp = data.doctor.newExacerbation;
            request(url)
                .post(patData_url+'/exacerbations')
                .set('Authorization', 'Bearer ' + access_token)
                .send (tmp)
        ...
        it('Post empty Exacerbation', function (done){
            var tmp = data.doctor.emptyExacerbation;
            request(url)
                .post(patData_url+'/exacerbations')
                .set('Authorization', 'Bearer ' + access_token)
                .send (tmp)
        ...
        it('Recordslists Length should be N+1', function (done){
            request(url)
                ...
                .end(function (err, res){
                    if (err) throw err;
                    res.body.should.have.property('exacerbations');
                    res.body.exacerbations.length.should.equal(list_length+1);
                    res.headers.should.have.property('last-modified');
        ...
        it('Doctor can delete certain Exacerbation Records', function (done){
            async.series
            ([
                function (cb) {
                    request(url)
                ...
                function (cb) {
                    request(url)
                        ...
                        .end(function (err, res){
                            ...
                            if (res.statusCode == 200) {
                                res.body.should.have.property('exacerbations');
                                res.body.exacerbations.length.should.equal(list_length);
                            }
                            if (err) throw cb(err);
                            cb(null, res);
    ...
    describe('Testing Functions as Patient:', function() {
        ...
        it('Patient cant get his List of Exacerbation Records', function (done){
            request(url)
                .get(patData_url + '/exacerbations')
                .set('Authorization', 'Bearer ' + access_token)
                .expect(403)
        ...
        it('Patient cant create new Exacerbation Record', function (done){
            request(url)
                .post(patData_url + '/exacerbations')
                .set('Authorization', 'Bearer ' + access_token)
                .send (data.admin.newExacerbation)
        ...
        it('Patient cant get a certain Exacerbation Record', function (done){
            request(url)
                .get(patData_url + '/exacerbations/42')
                .set('Authorization', 'Bearer ' + access_token)
                .expect(403)
        ...
        it('Patient cant delete Exacerbation Record', function (done){
            request(url)
                .del(patData_url + '/exacerbations/42')
                .set('Authorization', 'Bearer ' + access_token)
                .expect(403)
